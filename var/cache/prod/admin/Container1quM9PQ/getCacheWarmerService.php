 ...
 */
class getCacheWarmerService extends AdminKernelProdContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        return $container->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(new RewindableGenerator(function () use ($container) {
            ...
            yield 6 => ($container->privates['security.cache_warmer.expression'] ?? $container->load('getSecurity_CacheWarmer_ExpressionService'));
            ...
            yield 9 => ($container->services['main.warmer.cache_warmer'] ?? $container->load('getMain_Warmer_CacheWarmerService'));
            yield 10 => ($container->privates['PrestaShopBundle\\Routing\\AnonymousRouteProvider'] ?? $container->load('getAnonymousRouteProviderService'));
            yield 11 => ($container->privates['ux.twig_component.cache_warmer'] ?? $container->load('getUx_TwigComponent_CacheWarmerService'));
        }, 12), false, ($container->targetDir.''.'/AdminKernelProdContainerDeprecations.log'));
    }
}
