...
class getManufacturerAddressTypeService extends AdminKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \PrestaShopBundle\Form\Admin\Sell\Address\ManufacturerAddressType(($container->services['Symfony\\Contracts\\Translation\\TranslatorInterface'] ?? self::getTranslatorInterfaceService($container)), ($container->services['PrestaShop\\PrestaShop\\Adapter\\LegacyContext'] ?? self::getLegacyContextService($container))->getLanguages(false), ($container->services['prestashop.adapter.form.choice_provider.manufacturer_name_by_id'] ?? $container->load('getPrestashop_Adapter_Form_ChoiceProvider_ManufacturerNameByIdService'))->getChoices(), ($container->services['prestashop.adapter.form.choice_provider.country_state_by_id'] ??= new \PrestaShop\PrestaShop\Adapter\Form\ChoiceProvider\CountryStateByIdChoiceProvider()), ($container->services['PrestaShop\\PrestaShop\\Adapter\\LegacyContext'] ?? self::getLegacyContextService($container))->getContext()->country->id, $a);

        if (isset($container->privates['PrestaShopBundle\\Form\\Admin\\Sell\\Address\\ManufacturerAddressType'])) {
            return $container->privates['PrestaShopBundle\\Form\\Admin\\Sell\\Address\\ManufacturerAddressType'];
        }

        return $container->privates['PrestaShopBundle\\Form\\Admin\\Sell\\Address\\ManufacturerAddressType'] = $instance;
    }
}
