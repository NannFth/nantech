 ...
 */
class getTranslation_ReaderService extends AdminKernelProdContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addLoader('db', ($container->services['prestashop.translation.database_loader'] ?? $container->load('getPrestashop_Translation_DatabaseLoaderService')));
        $instance->addLoader('db', ($container->services['prestashop.translation.sql_loader'] ??= new \PrestaShopBundle\Translation\Loader\SqlTranslationLoader()));
        $instance->addLoader('legacy_files', ($container->services['prestashop.translation.loader.legacy_file'] ?? $container->load('getPrestashop_Translation_Loader_LegacyFileService')));
        $instance->addLoader('legacy_files', ($container->services['prestashop.translation.legacy_file_loader'] ?? $container->load('getPrestashop_Translation_LegacyFileLoaderService')));
