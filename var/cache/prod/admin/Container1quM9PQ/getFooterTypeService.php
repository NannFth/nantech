...
class getFooterTypeService extends AdminKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \PrestaShopBundle\Form\Admin\Sell\Product\FooterType(($container->services['Symfony\\Contracts\\Translation\\TranslatorInterface'] ?? self::getTranslatorInterfaceService($container)), ($container->services['PrestaShop\\PrestaShop\\Adapter\\LegacyContext'] ?? self::getLegacyContextService($container))->getLanguages(false), ($container->services['prestashop.adapter.shop.url.product_provider'] ?? $container->load('getPrestashop_Adapter_Shop_Url_ProductProviderService')), ($container->services['prestashop.adapter.shop.url.product_preview_provider'] ?? $container->load('getPrestashop_Adapter_Shop_Url_ProductPreviewProviderService')), $a, ($container->services['PrestaShop\\PrestaShop\\Adapter\\Feature\\MultistoreFeature'] ?? self::getMultistoreFeatureService($container)), ($container->services['PrestaShop\\PrestaShop\\Adapter\\LegacyContext'] ?? self::getLegacyContextService($container))->getContext()->shop->id);

        if (isset($container->privates['PrestaShopBundle\\Form\\Admin\\Sell\\Product\\FooterType'])) {
            return $container->privates['PrestaShopBundle\\Form\\Admin\\Sell\\Product\\FooterType'];
        }

        return $container->privates['PrestaShopBundle\\Form\\Admin\\Sell\\Product\\FooterType'] = $instance;
    }
}
