 ...
 */
class getMailThemeControllerService extends AdminKernelProdContainer
{
    /*
     * Gets the public 'PrestaShopBundle\Controller\Admin\Improve\Design\MailThemeController' shared autowired service.
     *
     * @return \PrestaShopBundle\Controller\Admin\Improve\Design\MailThemeController
     */
    public static function do($container, $lazyLoad = true)
    {
        $container->services['PrestaShopBundle\\Controller\\Admin\\Improve\\Design\\MailThemeController'] = $instance = new \PrestaShopBundle\Controller\Admin\Improve\Design\MailThemeController();
        ...
        $instance->setContainer((new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'PrestaShop\\PrestaShop\\Adapter\\MailTemplate\\MailPreviewVariablesBuilder' => ['services', 'PrestaShop\\PrestaShop\\Adapter\\MailTemplate\\MailPreviewVariablesBuilder', 'getMailPreviewVariablesBuilderService', true],
            ...
            'PrestaShop\\PrestaShop\\Core\\Grid\\Presenter\\GridPresenterInterface' => ['services', 'PrestaShop\\PrestaShop\\Core\\Grid\\Presenter\\GridPresenterInterface', 'getGridPresenterInterfaceService', true],
            ...
            'PrestaShop\\PrestaShop\\Core\\Language\\LanguageRepositoryInterface' => ['services', 'PrestaShopBundle\\Entity\\Repository\\LangRepository', 'getLangRepositoryService', false],
            'PrestaShop\\PrestaShop\\Core\\MailTemplate\\MailTemplateRendererInterface' => ['services', 'PrestaShop\\PrestaShop\\Adapter\\MailTemplate\\MailTemplateTwigRenderer', 'getMailTemplateTwigRendererService', true],
            'PrestaShop\\PrestaShop\\Core\\MailTemplate\\ThemeCatalogInterface' => ['services', 'PrestaShop\\PrestaShop\\Core\\MailTemplate\\FolderThemeCatalog', 'getFolderThemeCatalogService', true],
            ...
            'PrestaShop\\PrestaShop\\Adapter\\MailTemplate\\MailPreviewVariablesBuilder' => 'PrestaShop\\PrestaShop\\Adapter\\MailTemplate\\MailPreviewVariablesBuilder',
            ...
            'PrestaShop\\PrestaShop\\Core\\Language\\LanguageRepositoryInterface' => '?',
            'PrestaShop\\PrestaShop\\Core\\MailTemplate\\MailTemplateRendererInterface' => 'PrestaShop\\PrestaShop\\Adapter\\MailTemplate\\MailTemplateTwigRenderer',
            'PrestaShop\\PrestaShop\\Core\\MailTemplate\\ThemeCatalogInterface' => 'PrestaShop\\PrestaShop\\Core\\MailTemplate\\FolderThemeCatalog',
        ...
        ]))->withContext('PrestaShopBundle\\Controller\\Admin\\Improve\\Design\\MailThemeController', $container));
