...
class getResourceScopesTypeService extends AdminKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \PrestaShopBundle\Form\Admin\AdvancedParameters\AdminAPI\ResourceScopesType(($container->services['Symfony\\Contracts\\Translation\\TranslatorInterface'] ?? self::getTranslatorInterfaceService($container)), ($container->services['PrestaShop\\PrestaShop\\Adapter\\LegacyContext'] ?? self::getLegacyContextService($container))->getLanguages(false), ($container->privates['PrestaShopBundle\\ApiPlatform\\Scopes\\CachedApiResourceScopesExtractor'] ?? $container->load('getCachedApiResourceScopesExtractorService')), $a);

        if (isset($container->privates['PrestaShopBundle\\Form\\Admin\\AdvancedParameters\\AdminAPI\\ResourceScopesType'])) {
            return $container->privates['PrestaShopBundle\\Form\\Admin\\AdvancedParameters\\AdminAPI\\ResourceScopesType'];
        }

        return $container->privates['PrestaShopBundle\\Form\\Admin\\AdvancedParameters\\AdminAPI\\ResourceScopesType'] = $instance;
    }
}
