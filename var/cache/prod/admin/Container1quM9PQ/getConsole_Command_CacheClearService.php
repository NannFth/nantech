 ...
 */
class getConsole_Command_CacheClearService extends AdminKernelProdContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        $container->privates['console.command.cache_clear'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\CacheClearCommand(new \Symfony\Component\HttpKernel\CacheClearer\ChainCacheClearer(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->services['PrestaShopBundle\\Cache\\LegacyCacheClearer'] ??= new \PrestaShopBundle\Cache\LegacyCacheClearer((\dirname(__DIR__, 5).'/var/cache/prod'.\DIRECTORY_SEPARATOR.'')));
