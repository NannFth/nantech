 ...
 */
class getModuleManagementEventSubscriberService extends AdminKernelProdContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $b = ($container->services['PrestaShop\\Module\\Mbo\\Service\\View\\ContextBuilder'] ?? $container->load('getContextBuilderService'));

        if (isset($container->services['PrestaShop\\Module\\Mbo\\Addons\\Subscriber\\ModuleManagementEventSubscriber'])) {
            return $container->services['PrestaShop\\Module\\Mbo\\Addons\\Subscriber\\ModuleManagementEventSubscriber'];
        }

        $instance = new \PrestaShop\Module\Mbo\Addons\Subscriber\ModuleManagementEventSubscriber($a, $b, ($container->services['PrestaShop\\Module\\Mbo\\Distribution\\Client'] ?? $container->load('getClientService')), ($container->services['PrestaShop\\Module\\Mbo\\Api\\Security\\AdminAuthenticationProvider'] ?? $container->load('getAdminAuthenticationProviderService')), ($container->services['PrestaShop\\Module\\Mbo\\Distribution\\Config\\CommandHandler\\VersionChangeApplyConfigCommandHandler'] ?? $container->load('getVersionChangeApplyConfigCommandHandlerService')));

        if (isset($container->services['PrestaShop\\Module\\Mbo\\Addons\\Subscriber\\ModuleManagementEventSubscriber'])) {
            return $container->services['PrestaShop\\Module\\Mbo\\Addons\\Subscriber\\ModuleManagementEventSubscriber'];
        }

        return $container->services['PrestaShop\\Module\\Mbo\\Addons\\Subscriber\\ModuleManagementEventSubscriber'] = $instance;
    }
}
