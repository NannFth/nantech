 ...
 */
class getApiPlatform_Metadata_PropertySchema_OneOfRestrictionService extends AdminKernelProdContainer
{
    /*
    ...
    {
        $instance = new \ApiPlatform\Symfony\Validator\Metadata\Property\Restriction\PropertySchemaOneOfRestriction(new RewindableGenerator(function () use ($container) {
        ...
        if (isset($container->privates['api_platform.metadata.property_schema.one_of_restriction'])) {
            return $container->privates['api_platform.metadata.property_schema.one_of_restriction'];
        }

        return $container->privates['api_platform.metadata.property_schema.one_of_restriction'] = $instance;
    }
}
