...
class get_Container_Private_Prestashop_Core_Form_ChoiceProvider_GenderChoiceProviderService extends AdminKernelProdContainer
{
    ...
    {
        return $container->services['.container.private.prestashop.core.form.choice_provider.gender_choice_provider'] = new \PrestaShop\PrestaShop\Core\Form\ChoiceProvider\GenderChoiceProvider(($container->services['Symfony\\Contracts\\Translation\\TranslatorInterface'] ?? self::getTranslatorInterfaceService($container)));
    }
}
