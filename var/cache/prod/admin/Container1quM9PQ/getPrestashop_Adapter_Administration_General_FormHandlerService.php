...
class getPrestashop_Adapter_Administration_General_FormHandlerService extends AdminKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \PrestaShop\PrestaShop\Core\Form\Handler($a, ($container->services['PrestaShop\\PrestaShop\\Core\\Hook\\HookDispatcher'] ?? self::getHookDispatcherService($container)), ($container->services['prestashop.adapter.administration.general.form_provider'] ?? $container->load('getPrestashop_Adapter_Administration_General_FormProviderService')), 'PrestaShopBundle\\Form\\Admin\\Configure\\AdvancedParameters\\Administration\\GeneralType', 'AdministrationPageGeneral', 'general');

        if (isset($container->services['prestashop.adapter.administration.general.form_handler'])) {
            return $container->services['prestashop.adapter.administration.general.form_handler'];
        }

        return $container->services['prestashop.adapter.administration.general.form_handler'] = $instance;
    }
}
