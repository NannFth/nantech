...
class getLowStockThresholdTypeService extends AdminKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \PrestaShopBundle\Form\Admin\Sell\Product\Combination\LowStockThresholdType(($container->services['Symfony\\Contracts\\Translation\\TranslatorInterface'] ?? self::getTranslatorInterfaceService($container)), ($container->services['PrestaShop\\PrestaShop\\Adapter\\LegacyContext'] ?? self::getLegacyContextService($container))->getLanguages(false), $a);

        if (isset($container->privates['PrestaShopBundle\\Form\\Admin\\Sell\\Product\\Combination\\LowStockThresholdType'])) {
            return $container->privates['PrestaShopBundle\\Form\\Admin\\Sell\\Product\\Combination\\LowStockThresholdType'];
        }

        return $container->privates['PrestaShopBundle\\Form\\Admin\\Sell\\Product\\Combination\\LowStockThresholdType'] = $instance;
    }
}
