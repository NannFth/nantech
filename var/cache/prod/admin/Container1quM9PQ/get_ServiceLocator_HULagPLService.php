...
class get_ServiceLocator_HULagPLService extends AdminKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['.service_locator.hULagPL'])) {
            return $container->privates['.service_locator.hULagPL'];
        }

        return $container->privates['.service_locator.hULagPL'] = $instance;
    }
}
