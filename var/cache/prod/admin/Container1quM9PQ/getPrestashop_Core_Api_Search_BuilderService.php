...
class getPrestashop_Core_Api_Search_BuilderService extends AdminKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \PrestaShop\PrestaShop\Core\Search\Builder\ChainedFiltersBuilder([($container->services['prestashop.core.search.builder.typed'] ?? $container->load('getPrestashop_Core_Search_Builder_TypedService')), ($container->services['prestashop.core.search.builder.request'] ??= new \PrestaShop\PrestaShop\Core\Search\Builder\RequestFiltersBuilder()), $a]);

        if (isset($container->services['prestashop.core.api.search.builder'])) {
            return $container->services['prestashop.core.api.search.builder'];
        }

        return $container->services['prestashop.core.api.search.builder'] = $instance;
    }
}
