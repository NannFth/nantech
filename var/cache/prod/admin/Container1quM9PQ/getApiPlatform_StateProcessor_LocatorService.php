 ...
 */
class getApiPlatform_StateProcessor_LocatorService extends AdminKernelProdContainer
{
    /*
    ...
    {
        $instance = new \ApiPlatform\State\CallableProcessor(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'PrestaShopBundle\\ApiPlatform\\Processor\\UpdatePositionProcessor' => ['privates', 'PrestaShopBundle\\ApiPlatform\\Processor\\UpdatePositionProcessor', 'getUpdatePositionProcessorService', true],
            ...
            'PrestaShopBundle\\ApiPlatform\\Processor\\UpdatePositionProcessor' => 'PrestaShopBundle\\ApiPlatform\\Processor\\UpdatePositionProcessor',
        ...
        if (isset($container->privates['api_platform.state_processor.locator'])) {
            return $container->privates['api_platform.state_processor.locator'];
        }

        return $container->privates['api_platform.state_processor.locator'] = $instance;
    }
}
