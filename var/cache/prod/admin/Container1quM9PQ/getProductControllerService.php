...
class getProductControllerService extends AdminKernelProdContainer
{
    ...
    {
        $container->services['PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\Product\\ProductController'] = $instance = new \PrestaShopBundle\Controller\Admin\Sell\Catalog\Product\ProductController();
        ...
        $instance->setContainer((new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'PrestaShopBundle\\Entity\\Repository\\AdminFilterRepository' => ['services', 'PrestaShopBundle\\Entity\\Repository\\AdminFilterRepository', 'getAdminFilterRepositoryService', true],
            ...
            'PrestaShop\\PrestaShop\\Adapter\\LegacyContext' => ['services', 'PrestaShop\\PrestaShop\\Adapter\\LegacyContext', 'getLegacyContextService', false],
            'PrestaShop\\PrestaShop\\Adapter\\Module\\ModuleDataProvider' => ['services', 'PrestaShop\\PrestaShop\\Adapter\\Module\\ModuleDataProvider', 'getModuleDataProviderService', false],
            'PrestaShop\\PrestaShop\\Adapter\\Product\\Repository\\ProductRepository' => ['services', 'PrestaShop\\PrestaShop\\Adapter\\Product\\Repository\\ProductRepository', 'getProductRepository3Service', true],
            ...
            'PrestaShopBundle\\Entity\\Repository\\AdminFilterRepository' => 'PrestaShopBundle\\Entity\\Repository\\AdminFilterRepository',
            'PrestaShopBundle\\Service\\Grid\\ResponseBuilder' => '?',
            'PrestaShop\\PrestaShop\\Adapter\\LegacyContext' => 'PrestaShop\\PrestaShop\\Adapter\\LegacyContext',
            'PrestaShop\\PrestaShop\\Adapter\\Module\\ModuleDataProvider' => 'PrestaShop\\PrestaShop\\Adapter\\Module\\ModuleDataProvider',
            'PrestaShop\\PrestaShop\\Adapter\\Product\\Repository\\ProductRepository' => 'PrestaShop\\PrestaShop\\Adapter\\Product\\Repository\\ProductRepository',
        ...
        ]))->withContext('PrestaShopBundle\\Controller\\Admin\\Sell\\Catalog\\Product\\ProductController', $container));
