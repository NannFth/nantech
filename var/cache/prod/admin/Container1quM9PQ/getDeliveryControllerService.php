...
class getDeliveryControllerService extends AdminKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.4bDe9Ei'] ?? $container->load('get_ServiceLocator_4bDe9EiService'))->withContext('PrestaShopBundle\\Controller\\Admin\\Sell\\Order\\DeliveryController', $container));
