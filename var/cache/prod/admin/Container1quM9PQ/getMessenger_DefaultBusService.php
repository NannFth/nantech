 ...
 */
class getMessenger_DefaultBusService extends AdminKernelProdContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        $instance = new \Symfony\Component\Messenger\MessageBus(new RewindableGenerator(function () use ($container) {
            ...
            yield 4 => ($container->privates['PrestaShopBundle\\CommandBus\\Middleware\\CommandRegisterMiddleware'] ?? $container->load('getCommandRegisterMiddlewareService'));
