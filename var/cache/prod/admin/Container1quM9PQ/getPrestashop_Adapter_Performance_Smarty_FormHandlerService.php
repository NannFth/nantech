...
class getPrestashop_Adapter_Performance_Smarty_FormHandlerService extends AdminKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->services['prestashop.adapter.performance.smarty.form_handler'])) {
            return $container->services['prestashop.adapter.performance.smarty.form_handler'];
        }

        $instance = new \PrestaShop\PrestaShop\Core\Form\Handler($a, ($container->services['PrestaShop\\PrestaShop\\Core\\Hook\\HookDispatcher'] ?? self::getHookDispatcherService($container)), ($container->services['prestashop.adapter.performance.smarty.form_provider'] ?? $container->load('getPrestashop_Adapter_Performance_Smarty_FormProviderService')), 'PrestaShopBundle\\Form\\Admin\\AdvancedParameters\\Performance\\SmartyType', 'PerformancePageSmarty', 'smarty');

        if (isset($container->services['prestashop.adapter.performance.smarty.form_handler'])) {
            return $container->services['prestashop.adapter.performance.smarty.form_handler'];
        }

        return $container->services['prestashop.adapter.performance.smarty.form_handler'] = $instance;
    }
}
