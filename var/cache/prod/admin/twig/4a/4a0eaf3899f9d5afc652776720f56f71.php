...
class __TwigTemplate_617f2766ed8be0747e98c011eb4adc0b extends Template
{
  ...
  <li id=\"employee_infos\" class=\"dropdown\">
    ...
    <ul id=\"employee_links\" class=\"dropdown-menu dropdown-menu-right\">
      <li class=\"employee-wrapper-avatar\" data-mobile=\"true\" data-from=\"employee_links\" data-target=\"menu\">
        ...
        // line 16
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["this"] ?? null), "employee", [], "any", false, false, false, 16), "imageUrl", [], "any", false, false, false, 16), "html", null, true);
      ...
      ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["menuItem"]) {
          ...
          <a class=\"dropdown-item\" href=\"";
            // line 26
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["menuItemProperties"] ?? null), "link", [], "any", false, false, false, 26), "html", null, true);
            yield "\" ";
            if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["menuItemProperties"] ?? null), "isExternalLink", [], "any", false, false, false, 26)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                yield " target=\"_blank\"";
            }
            ...
            if (CoreExtension::getAttribute($this->env, $this->source, ($context["menuItemProperties"] ?? null), "icon", [], "any", true, true, false, 27)) {
                ...
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["menuItemProperties"] ?? null), "icon", [], "any", false, false, false, 28), "html", null, true);
                yield "</i>
            ";
            }
            // line 30
...
";
    ...
    {
        return array (  147 => 38,  144 => 37,  130 => 36,  126 => 34,  124 => 33,  117 => 30,  111 => 28,  109 => 27,  101 => 26,  96 => 25,  93 => 24,  76 => 23,  68 => 20,  64 => 19,  58 => 16,  46 => 7,  42 => 5,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "@PrestaShop/Admin/Component/LegacyLayout/employee_dropdown.html.twig", "C:\\xampp\\htdocs\\nantech-store\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Component\\LegacyLayout\\employee_dropdown.html.twig");
    }
}
